...
export function ngrTransformStringPrototypeCall(
        ...
        case "split":
            return lua.createCallExpression(
                lua.createTableIndexExpression(
                    lua.createIdentifier("string"), lua.createStringLiteral("split")
                ),
                [
                    caller,
                    ...params
...
export function ngrTransformStringConstructorCall(
    context: TransformationContext,
    node: ts.CallExpression,
    calledMethod: ts.PropertyAccessExpression
): lua.Expression | undefined {
...
export function ngrTransformStringProperty(
    context: TransformationContext,
