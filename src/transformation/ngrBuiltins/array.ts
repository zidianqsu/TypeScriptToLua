...
export function ngrTransformArrayConstructorCall(
...
export function ngrTransformArrayPrototypeCall(
    context: TransformationContext,
    node: ts.CallExpression,
    calledMethod: ts.PropertyAccessExpression
): lua.Expression | undefined {
        ...
        case "map":
            return lua.createCallExpression(
                lua.createTableIndexExpression(
                    lua.createIdentifier("table"), lua.createStringLiteral("map")
                ),
                [
                    caller,
                    ...params
...
export function ngrTransformArrayProperty(
    context: TransformationContext,
